        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={introStyle}>
              A colleague is looking for a therapist for their client. Review
              the details below to see if this is a good fit for your practice.
            </Text>
            ...
            <Section style={detailsBoxStyle}>
              ...
              <Text style={detailLabelStyle}>Modality</Text>
              <Text style={detailValueStyle}>{modality}</Text>

              {additionalNotes ? (
                <>
                  <Text style={detailLabelStyle}>Additional Notes</Text>
                  <Text style={detailValueStyle}>{additionalNotes}</Text>
                </>
              ) : null}
            </Section>
          ...
          <Section style={footerStyle}>
            <Text style={footerTextStyle}>
              You received this email because you are a registered therapist on
              the Therapist Referral Network and your profile matched this
              referral.
            </Text>
            <Text style={footerTextStyle}>
